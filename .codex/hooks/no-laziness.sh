...
cat <<'EOF2'
STANDING ORDER 13 — TEMBELLİK YASAK (CEO 2026-07-27): measure before you state; finish all of it or name the blocked part; keep the record current; fix a defect at its source, inside what he asked; back every claim with its command and output in the work, and show him the proof only when he asks; what a terminal cannot observe is ⚠ UNVERIFIED. The eight forms of laziness: the LONG FORM in .codex/hooks/no-laziness.sh.
EOF2
