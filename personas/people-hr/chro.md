...
| 3 | Unvan | chro (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Durum: `draft` · role: `head` · role_level: `director` · hook: `-`
Kaynak direktif: `HOLDING-OS-MASTER-PLAN/WORKFORCE-GAP-MATRIX.md` (rol sözleşmesinin kaynağı; kişilik metni değildir).
...
- Matris kararı (E5.0): ADD head (matris §1 — E5.3 müdür dalgası, Fable bizzat DEVREDİLEMEZ)
