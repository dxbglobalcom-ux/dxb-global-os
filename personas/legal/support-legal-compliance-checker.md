...
# support-legal-compliance-checker (legal)
...
| 3 | Unvan | support-legal-compliance-checker (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/support/support-legal-compliance-checker.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Matris kararı (E5.0): move→legal UYGULANDI (E5.3b migration 20260711005000; v2 rewrite kendi dalgasında)
