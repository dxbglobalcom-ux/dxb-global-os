...
| 3 | Unvan | project-management-experiment-tracker (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/project-management/project-management-experiment-tracker.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
