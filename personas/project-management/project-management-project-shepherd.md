...
| 3 | Unvan | project-management-project-shepherd (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/project-management/project-management-project-shepherd.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
