...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `9f2aea7d-3cf0-4f44-82e3-da6af8559f04` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | project-manager-senior (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/project-management/project-manager-senior.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Matris kararı (E5.0): merge→project-shepherd (dosya ölür, rol yaşar — v2 hedef rolde yazılır)
