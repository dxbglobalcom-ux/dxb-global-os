...
| 3 | Unvan | project-management-studio-producer (rol adı; v2 yazımında Türkçe unvan netleşir) |
| 4 | Şirket | DXB Global Technology Consultancy (holding) |
| 5 | Departman | project-management |
| 6 | Yönetici | ⏳ E5.3'te müdür ataması (`manager_id` backfill — matris §5.2) |
| 7 | Alt çalışanlar | — |
| 8 | Kullanılan model | agency-agents/project-management/project-management-studio-producer.md (`agents.brain`; MODEL_ROUTING_SPEC'e tabi) |
