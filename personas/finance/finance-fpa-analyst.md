...
| 3 | Unvan | finance-fpa-analyst (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/finance/finance-fpa-analyst.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
