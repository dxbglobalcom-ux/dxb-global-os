...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `870ed85c-8943-4ce4-9e13-a2852dc0e3ce` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | retail-customer-returns (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/retail-customer-returns.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
