...
# specialized-mcp-builder (data-ai)
...
| 3 | Unvan | specialized-mcp-builder (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/specialized-mcp-builder.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
