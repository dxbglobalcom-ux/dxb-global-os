...
# engineering-threat-detection-engineer (security)
...
| 3 | Unvan | engineering-threat-detection-engineer (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/engineering/engineering-threat-detection-engineer.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Dalga: D2 (WORKFORCE-GAP-MATRIX §5.5)
- Matris kararı (E5.0): move→security UYGULANDI (E5.3b migration 20260711005000; v2 rewrite kendi dalgasında)
