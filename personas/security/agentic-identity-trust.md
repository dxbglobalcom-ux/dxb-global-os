...
# agentic-identity-trust (security)
...
| 3 | Unvan | agentic-identity-trust (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/agentic-identity-trust.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
