...
## 6. Kalite kriterleri
İyi çıktı tanımı: her tuning (a) önce/sonra ölçüm-çiftli, (b) beklenti-kayıtlı (beklenen↔gerçekleşen), (c) geri-alınabilir, (d) envanter-kayıtlı — dördü birden; her migration-incelemesi kilit-sınıfı + süre projeksiyonu + pencere önerisi taşır.
...
## 10. Memory kullanımı
Kaydeder: tuning içtihatları (beklenti→sonuç çiftleri), kilit-vaka dersleri, plan-regresyon desenleri, kapasite projeksiyon geçmişi (tahmin↔gerçekleşen kalibrasyonu), tuzak listesi güncellemeleri.
