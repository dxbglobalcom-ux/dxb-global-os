...
# engineering-database-optimizer (platform)
...
| 3 | Unvan | engineering-database-optimizer (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/engineering/engineering-database-optimizer.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
