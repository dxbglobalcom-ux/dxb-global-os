...
# support-infrastructure-maintainer (platform)
...
| 3 | Unvan | support-infrastructure-maintainer (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/support/support-infrastructure-maintainer.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Dalga: D3 (WORKFORCE-GAP-MATRIX §5.5)
- Matris kararı (E5.0): move→platform UYGULANDI (E5.3b migration 20260711005000; v2 rewrite kendi dalgasında)
