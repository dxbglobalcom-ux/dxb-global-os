...
# social-media-orchestrator (social-media)
...
| 3 | Unvan | social-media-orchestrator (rol adı; v2 yazımında Türkçe unvan netleşir) |
| 4 | Şirket | DXB Global Technology Consultancy (holding) |
| 5 | Departman | social-media |
...
| 31 | Versiyon geçmişi | v0-add (ADD — legacy karşılığı yok); v2 Fable-yazımı BEKLİYOR |
| 32 | Oluşturan sistem | iskelet: gen-workforce-dossiers.sh (mekanik); kişilik yazarı: fable-5 (bekliyor) |
| 33 | Son güncelleme | 2026-07-11 |

Durum: `dormant` · role: `head` · role_level: `⏳ E5.3 backfill` · hook: `-`
...
- Dalga: E5.6 (CEO direktifi 2026-07-11 — müdür dalgası sonrası) (WORKFORCE-GAP-MATRIX §5.5)
- Matris kararı (E5.0): ADD (CEO direktifi 2026-07-11 — 00-CEO-DIRECTIVE-SOCIAL-MEDIA-DEPT; legacy karşılığı yok, sıfırdan Fable yazımı)
