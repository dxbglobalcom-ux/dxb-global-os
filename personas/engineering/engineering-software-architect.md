...
| 3 | Unvan | engineering-software-architect (rol adı; v2 yazımında Türkçe unvan netleşir) |
| 4 | Şirket | DXB Global Technology Consultancy (holding) |
| 5 | Departman | engineering |
| 6 | Yönetici | ⏳ E5.3'te müdür ataması (`manager_id` backfill — matris §5.2) |
| 7 | Alt çalışanlar | — |
| 8 | Kullanılan model | agency-agents/engineering/engineering-software-architect.md (`agents.brain`; MODEL_ROUTING_SPEC'e tabi) |
...
- Matris kararı (E5.0): promote+rewrite → departman müdürü (E5.3 müdür dalgası)
