...
| 3 | Unvan | engineering-git-workflow-master (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/engineering/engineering-git-workflow-master.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
