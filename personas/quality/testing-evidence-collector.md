...
# testing-evidence-collector (quality)
...
| 3 | Unvan | testing-evidence-collector (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/testing/testing-evidence-collector.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
