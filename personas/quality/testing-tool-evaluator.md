...
# testing-tool-evaluator (quality)
...
| 3 | Unvan | testing-tool-evaluator (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/testing/testing-tool-evaluator.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
