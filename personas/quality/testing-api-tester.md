...
| 3 | Unvan | testing-api-tester (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/testing/testing-api-tester.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
