...
# testing-accessibility-auditor (quality)
...
| 3 | Unvan | testing-accessibility-auditor (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/testing/testing-accessibility-auditor.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
