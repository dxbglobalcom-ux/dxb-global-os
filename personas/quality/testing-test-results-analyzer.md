...
# testing-test-results-analyzer (quality)
...
| 3 | Unvan | testing-test-results-analyzer (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/testing/testing-test-results-analyzer.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
