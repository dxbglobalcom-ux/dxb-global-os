...
| 3 | Unvan | accounts-payable-agent (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/accounts-payable-agent.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
