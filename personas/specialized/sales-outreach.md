...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `840196a0-b7de-4412-9ea8-396487756f58` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | sales-outreach (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/sales-outreach.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Matris kararı (E5.0): merge→sales/outbound-strategist (dosya ölür, rol yaşar — v2 hedef rolde yazılır)
