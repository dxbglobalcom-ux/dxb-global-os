...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `0f6b8209-c6ab-48c8-867a-5a9f09ddbd16` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | government-digital-presales-consultant (rol adı; v2 yazımında Türkçe unvan netleşir) |
| 4 | Şirket | DXB Global Technology Consultancy (holding) |
| 5 | Departman | specialized |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/government-digital-presales-consultant.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Dalga: D1-D3 (move hedefine göre — matris §2) (WORKFORCE-GAP-MATRIX §5.5)
- Matris kararı (E5.0): retire→library ÖNERİSİ (CEO onayı bekler — silme değil arşiv; onaya kadar kadroda pasif)
