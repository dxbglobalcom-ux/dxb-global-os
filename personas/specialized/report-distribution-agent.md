...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `8aae0e40-ff0a-4182-957d-2ae5e71721a1` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | report-distribution-agent (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/report-distribution-agent.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Matris kararı (E5.0): merge→revops/Revenue Reporting Agent (dosya ölür, rol yaşar — v2 hedef rolde yazılır)
