...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `4316d8aa-62af-49d9-a7ee-1c1ec9203070` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | legal-client-intake (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/legal-client-intake.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
