...
| 3 | Unvan | lsp-index-engineer (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/lsp-index-engineer.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Matris kararı (E5.0): move→engineering (+v2 rewrite; taşıma E5.3+ migration'la)
