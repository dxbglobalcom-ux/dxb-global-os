...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `3de5589a-78ec-4938-ae63-5c38789ddc16` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | customer-service (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/customer-service.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Matris kararı (E5.0): merge→customer-success/support-responder (dosya ölür, rol yaşar — v2 hedef rolde yazılır)
