...
| 3 | Unvan | support-support-responder (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/support/support-support-responder.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
