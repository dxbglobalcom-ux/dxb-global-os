...
| # | Alan | Değer |
|---|------|-------|
| 1 | Employee ID | `bbdbd53b-0322-4be7-8f61-f30bc1e0c48e` |
| 2 | İsim | — (isim politikası: uydurma ad yok; rol adıyla anılır) |
| 3 | Unvan | support-finance-tracker (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/support/support-finance-tracker.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Matris kararı (E5.0): merge→finance/fpa-analyst (dosya ölür, rol yaşar — v2 hedef rolde yazılır)
