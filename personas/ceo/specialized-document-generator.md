...
# specialized-document-generator (ceo)
...
| 3 | Unvan | specialized-document-generator (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/specialized/specialized-document-generator.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
...
- Dalga: D1 (WORKFORCE-GAP-MATRIX §5.5)
- Matris kararı (E5.0): move→ceo-office UYGULANDI (E5.3b migration 20260711005000; v2 rewrite kendi dalgasında)
