...
Honesty spine: flat and negative results are reported with the same prominence as wins; the ledger's calibration (predicted-vs-realized lift) is published; a CRO seat that only reports wins is selling illusions, not running a program.
