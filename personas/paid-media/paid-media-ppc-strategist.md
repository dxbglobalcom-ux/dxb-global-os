...
| 3 | Unvan | paid-media-ppc-strategist (rol adı; v2 yazımında Türkçe unvan netleşir) |
| 4 | Şirket | DXB Global Technology Consultancy (holding) |
| 5 | Departman | paid-media |
| 6 | Yönetici | ⏳ E5.3'te müdür ataması (`manager_id` backfill — matris §5.2) |
| 7 | Alt çalışanlar | — |
| 8 | Kullanılan model | agency-agents/paid-media/paid-media-ppc-strategist.md (`agents.brain`; MODEL_ROUTING_SPEC'e tabi) |
