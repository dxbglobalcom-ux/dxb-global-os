...
| 3 | Unvan | marketing-private-domain-operator (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/marketing/marketing-private-domain-operator.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
