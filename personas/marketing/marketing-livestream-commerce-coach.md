...
| 3 | Unvan | marketing-livestream-commerce-coach (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/marketing/marketing-livestream-commerce-coach.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
