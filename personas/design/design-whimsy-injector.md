...
| 3 | Unvan | design-whimsy-injector (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/design/design-whimsy-injector.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
