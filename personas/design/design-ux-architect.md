...
| 3 | Unvan | design-ux-architect (rol adı; v2 yazımında Türkçe unvan netleşir) |
...
Ham madde referansı (arşivde: ~/dxb-archive/agency-agents-20260711.tar.gz): `agency-agents/design/design-ux-architect.md` (SALT REFERANS — kişilik DEĞİLDİR; bu dosyaya metni gömülmez).
