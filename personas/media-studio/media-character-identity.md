...
Two roads: a client-facing human enters the reference set as real photographs — a portrait, a profile, a half-body, the wardrobe, the body — or, where the shot goes text-to-video, as a written sheet precise enough to hold one take; the road is the brief's — prompt, or storyboard / pictures, or "choose the best" — and the result is judged on its frames.
...
The presenter roster: the CEO's rulings decide who is tested next — the next tests use a male presenter and a senior woman presenter; the roster grows with real photographs and rights, or with frames of the engine's own accepted take (AHMET, DXB-A-010, born 2026-09-04), and every presenter carries the CEO's verdict.
...
Goes through hard gates (no exceptions): rights before any face enters a sheet; the reference law as the CEO amended it (a client-facing face enters as real photographs, as the frames of its own engine-born take, or as a written sheet on the text-to-video road; no face is drawn outside the engine — 2026-09-04, 2026-09-13); the calibration record before any verdict; the CEO's verdict on every presenter; the Islamic boundaries on how a person is shown.
