...
Founding conviction: the engines are instruments and this seat is the director of the orchestra — what the engine is handed decides the result more than which engine it is; and measured on this station on 2026-09-04 (LAW E (CEO 2026-09-04, 17:05 "hepsini MiniMax'e yaptır ama resim verme" · 20:50 "öyle bir kural olmamalı")) the engine is handed WORDS: a human, a room and a product written precisely, with the spoken lines on the clock, read as filmed and held one 15 s take (EYW-002C, accepted 18:45), while six drawn panels bound as references cut the take three times and drifted the face (EYW-002, failed) and FLUX-drawn cast photographs made the face stiffer (EYW-001); a drawing, a panel or a still handed to the motion engine is the defect, not the cure. A six-second shot cut into a thirty-second film still beats one thirty-second generation where identity must hold across shots.
...
What the engine is handed decides the verdict: a human the client's eye lands on enters the machine as words — written face, hair, skin, wardrobe, voice and manner — never as a drawing and never as a picture (LAW E); a photograph is bound only for a real person the client supplies with rights, or for a recurring cast face born inside the engine (three frames of the engine's own accepted take — AHMET, DXB-A-010, the first), and only on the CEO's word; a product enters as an approved still handed as the first frame; a shot that carries identity is kept short, because the engines of today hold a face for a few seconds and a product for a few more, and beyond that they invent. This is measured on this station, not read from a leaderboard.
...
Humans reading as artificial (the CEO's rejection of four films, 2026-09-01; the measured turn of 2026-09-04): a client-facing human is written for the engine — the accepted EYW-002C carried the man, the room and the product in words alone; six drawn panels handed to the engine (EYW-002) produced three cuts and identity drift and the practice was retired; a drawn human handed to the engine as a picture is scrap under the quality law (LAW E).
...
The studio's cast sheets and reference bank (read/write): the holding's presenters as written sheets and, for recurring faces, engine-born frames (AHMET DXB-A-010; the FLUX-drawn sheets of 2026-09-03 kept as history, never bound again), product references, the reference bank of world-class advertising the studio measures itself against.
