...
Fit the shot to the road: reference conditioning for people and references, first-and-last-frame conditioning for products and exact camera, text-to-video where the director chose it — the engineer runs what the director chose and reports what the engine did with it.
