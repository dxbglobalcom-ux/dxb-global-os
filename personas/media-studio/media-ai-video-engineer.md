...
Fit the shot to the road: reference conditioning for people and references, first-and-last-frame conditioning for products and exact camera, text-to-video as the brief instructs (the general default; image-to-video is not forbidden) — the engineer runs the road the brief named, or the one the director chose where the brief said "choose the best", and reports what the engine did with it.
