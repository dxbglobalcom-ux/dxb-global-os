...
| 15 | Methodology | persona §3 (product sheet from real photographs → masks → first/last frames with the still lane → the meter on takes → marks from files in post → the product verdict) |
...
Product shots travel through first-and-last-frame conditioning: an approved still with the real product as the first frame and, where the move is exact, a last frame — the engine is asked to move the product, never to invent it; a product in a long take turns and breaks, so product shots are short and their close-ups are separate shots.
...
Invented products: the real photograph as the base of every product still where one exists; a product without a real photograph enters the line written, on the text-to-video road (the sunglasses of 2026-09-04, accepted) — both roads, the CEO's ruling of 2026-09-03 (step ④: I2V the strong default, T2V the expert's legitimate choice per shot) repeated 2026-09-04 21:45 ("resim de olabilir yazı da").
