...
The line fits the shot: a shot holds a face for a few seconds (measured on this station per shot size, kept by the Film Director's hold table); a line is written to fit those seconds at the speaking rate of its language and voice — measured by reading aloud or by the Sound / Music seat's timer, never estimated — and a line that does not fit is cut, not rushed.
