...
Long form: scene-level continuity sheets; anchor chains; the un-generated share (real stills with movement, motion graphics) checked for the same continuity — a still of the wrong car breaks the film as surely as a generated one.
