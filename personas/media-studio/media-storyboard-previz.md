...
UGC pieces: panels are the presenter's real photograph in the real room with the real product, framed as a phone frames — the board is short and the animatic is the whole test.
...
## 6. Quality criteria
Good-output definition: a board is good when (a) every shot has an approved panel at its destination's ratio and safe zones, (b) every client-facing human and product in a panel is the real photograph, (c) no readable lettering reaches the engine, (d) the animatic plays the cut at measured seconds and the Film Director and Creative Director approved it, (e) the hero frame passed the CEO's eye — all five.
