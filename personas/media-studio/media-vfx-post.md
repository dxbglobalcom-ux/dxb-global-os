...
Cost consciousness: pixels cost card minutes — the delivery size is the format's, not the maximum; the enlarger runs once per shot the CEO has accepted and asked to enlarge, never per candidate and never before his eye; the finish is planned at the shot list so that what needs no finish gets none.
