...
| 3 | **Denial split: finance denies docusign, legal-de denies stripe** — ✅ **CEO CONFIRMED 2026-07-09** | Doc line 39 says "Stripe/DocuSign visible only to the finance/legal specialist's .mcp.json" without splitting. Least-privilege reading applied: Stripe→finance only, DocuSign→legal-de only. CEO approved the split same day — no longer an open assumption. Widening = ⛔ Fable change. |
