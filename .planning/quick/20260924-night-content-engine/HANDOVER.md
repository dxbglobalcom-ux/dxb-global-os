...
## Your first message
The position (CLAUDE.md §0): the SIGNAL plan waits for his eye; next is the Fable study (say what its folder shows, measured) and the three open questions; name what is blocked on him. Then say in one or two plain sentences that you have read the handover and are following the Fable study. Do not ask him what to do.
