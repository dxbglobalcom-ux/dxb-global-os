...
**Status: PLAN — rewritten 2026-09-24 after the whole source was watched and heard; NOTHING IS BUILT; it waits for his eye.** <!-- OPEN: B43 --> **The ORDER of its phases was approved by his "tamam" on 2026-09-24 22:55 (§3a, a registered adaptation inside this plan) <!-- CEO-OK: signal-plan-order-tamam-2026-09-24 --> — the order only; the plan itself is not approved, Phase 0 does not start, no code.**
...
1. **Her marka müşterisinin sektörü — asıl geliri getiren masa.** Örnek: Dubai'de bir restoranla anlaşılır; motor Dubai'deki diğer restoranların videolarında neyin tuttuğunu bulur, o restoranın reklamı buna göre yapılır. Marka aylık ücreti (B28'deki 8.000 dolar), reklam tahmine değil kanıta dayandığı için öder. **İlk para adımı anlaşma değil, ücretli sektör incelemesidir** (sizin onayladığınız sıra, 2026-09-24 22:55, §3a): motorun 4. fazdan çıkan kalıplarıyla o sektör için yazılan tek belge — "sektörünüzün en gürültülü üç hesabı bu ay neyi tutturdu, sizin son 30 videonuz bunun neresinde" — önce satılır, inceleme kanıt olur, kanıt anlaşmaya döner (gelir çalışması `../20260924-signal-revenue-study/STUDY.md` kalem 3.2 ve 3.1).
...
| 5 | **Ücretli sektör incelemesi — ilk para adımı** | Bir masanın sektörü için, 3. ve 4. fazın satırlarından yazılan tek belge: bu ay sektörün en gürültülü üç hesabı neyi tutturdu (kalıplar, kat, n, hesap sayısı), müşteri adayının son 30 videosu bunun neresinde, bir sonraki videoda ne yapılmalı. Motor belgeyi üretir; satışı ve fiyatı ajans koltuğunun (B28; gelir çalışması kalem 3.2). Ekran yok, para ekransız gelir | `node scripts/signal/review.mjs --desk <masa>` → belge çıkar; içindeki her sayı bir kalıp veya video satırına iner (adres adres); n < 5 olan kalıp belgede yok; motorun bilmediği bir rakam belgede yok |
| 6 | **Senaryo stüdyosu** | Tek özgün senaryo: kanıtlı konu, açılış, açı, yapı; 3 yedek açılış; editör puan kartı ve düzeltme geçişi; zaman kodlu çekim metni; "neden bu senaryo" kanıtlarıyla. B43 sırasına girer | Senaryo dayandığı videoları gösterir; "evet"le B43 kuyruğunda iş olur |
| 7 | **Hafıza + Hamza** | Kapıdan geçen her videonun notu holding hafızasına yazılır; Hamza bu veriden cevap verir | Hamza'ya "bu hafta hangi açılış tuttu?" sorusu, kalıp tablosundaki ile aynı cevabı sesli verir |
| 8 | **Döngü** | Her müşteriye ürettiğimiz video müşterinin hesabında yayınlanınca (ve kendi hesabımız açılınca onun videoları) okunur ve çözümlenir; senaryonun tahmini ile gerçek sonucu yan yana yazılır (anlaşmayı tutan aylık hesap raporu, gelir çalışması kalem 3.10). Deneme için ayrıca video üretilmez | Yayınlanan her müşteri videosu için 7. günde çözümleme ve "tahmin vs gerçek" satırı var |
| 9 | **Ekran — en son** | B32'de çizimini onayladığınız oda: Call sheet · Video tablosu · Kalıplar · Senaryo stüdyosu · Masalar · Hat. **Canlı iş paneli** her an açık ("çözümleniyor 156/435 · sonraki yenileme 23 sa"); Hat sekmesinde çalışan düğüm yanar. İlk incelemeler ve ilk anlaşmalar bu faz olmadan yapılır | Sizin kabul testiniz: sayfayı açarsınız, dokunmazsınız, işin ilerlediği görünür |

### 3a. Kayıtlı adaptasyon — sıra, ilk masalar, kapsam ve müşteri süzgeci (sizin sözünüzle, 2026-09-24 22:55) <!-- CEO-OK: signal-plan-order-tamam-2026-09-24 -->

Sözünüz, birebir: *"tamam plan sırasını baş mühendise yazdır. önce bir session aç kendin. dxb crew skill'ini kullan"* (gelir çalışmasının kaydı: `../20260924-signal-revenue-study/EVIDENCE.md` E13.1; o gece söylediklerinizin tamamı orada, E12.1 ve E13.1). Bu söz planın **sırasını** onaylar; planın kendisini onaylamaz. Onaylanan sıra ve bu plana işlenen değişiklikler:

1. **Önce ücretli sektör incelemesi, ekran en sonda.** Faz 5 (inceleme) yeni girdi; eski Faz 7 (ekran) Faz 9 oldu ve en sona geçti. Eşleme, başka kayıtların atıfları için: eski 0–4 = yeni 0–4 · eski 5 (senaryo) = yeni 6 · eski 6 (hafıza) = yeni 7 · eski 8 (döngü) = yeni 8 · **eski 7 (ekran) = yeni 9**. Gelir çalışmasının §4.2'sindeki "SIGNAL Faz 0–4" aynı kaldı; oradaki "Ekran (Faz 7)" bu planın yeni Faz 9'udur. İlk 90 günde ekran çizilmez (B32 onayınızı bekler); inceleme ve anlaşma ekransız yapılır.
2. **İlk masalar: kazanmak istediğimiz markaların sektörleri, her kıtada birer.** §4'teki "ilk masa hangisi" sorusu böyle cevaplandı; stüdyonun kendi alanı ayrı bir masadır, ilk masa değildir. OUTLETEURO bu ürünün masası değildir (sizin sözünüz, 2026-09-24: *"Outleteuro DxB Holding kurulduktan sonra holding bir lüks marka e-ticaret sitesidir. gerek var şimdlik?"*).
3. **Kapsam ilk günden uluslararası** (*"ben size uluslararası diorm bana specific şeyle gelemyin"*, *"en ticari hacmi yüksek ülkeleri sen seç"*): 26 satırda 28 ülke (Katar+Kuveyt ve Nijerya+Mısır birer satırı paylaşır) ticari hacme göre ve her birinde ilk müşterinin nasıl alınacağı gelir çalışması §2.8'dedir; masa açılırken ülke, dil ve kapıdaki ortak oradan okunur. Amaç ülkeleri didik didik etmek değil, her ülkede müşteri almak (*"amaç tüm ülkelerin didik didik etmek değil tabiki ama her ülkede müşteri almak"*).
4. **Müşteri süzgeci** §5'e yazıldı; sınırın sahibi anayasadır (`MASTER_PLAN.md` §11, "Immutable Islamic boundaries"), bu plan onu ne genişletir ne daraltır.

Bu sıra bir oturum emridir; kanun değildir. Planın kendisi, Faz 0'ın başlaması ve her para çıkışı sizin sözünüzü bekler.

## 4. Sizin kararınız gereken iki şey

1. **Ücretli yol:** Köprü ve Speaches Faz 0'da yetmezse Apify (videoda ayda yaklaşık 5 dolar) ve Scribe fiyatlarıyla önünüze gelir. Para çıkışı sizin onayınızdır.
2. **Paylaşım:** Önerim, motorun yalnız okuyup önermesi; paylaşma kararı her zaman sizde.
...
- **Müşteri süzgeci — sınır anayasadır, bu plan onu uygular** (`MASTER_PLAN.md` §11, "Immutable Islamic boundaries": alkol, tütün, domuz, uyumsuz finans, dolandırıcılık, müstehcen içerik haram; kripto ve borsa fırsat taramasının dışında; bahis bir üstteki B28 çizgisi). Sizin 2026-09-24'teki sözünüzle netleşen yeri: *"alkolun reklamı yapılmaz banka reklamı da yapılmaz aldi bir market ama içinde alkol var sadece aldinin reklamı yaplır"* ve *"bu holding islam şeriat kanunları göre işleyen bir holding haram ürünler satılmaz gelir kesinlikle buralardan gelemez"* — hiçbir banka müşteri değildir; hiçbir kripto şirketi müşteri değildir (*"hayır kripto falan bunlar asla"*, 2026-09-24 20:20, gelir çalışmasının kaydı E11.1); alkol markası müşteri değildir; alkol da satan bir süpermarket zinciri müşteridir, yalnız zincirin kendi reklamı yapılır, içindeki alkol ve domuzun asla. Faizli sigorta müşteri değil, tekafül olur — bu, gelir çalışmasının "helal çerçevede" sözünüzden okumasıdır (STUDY §6), sizin adını koyduğunuz bir cümle değildir. Bu masaya böyle bir hesap eklenmez, böyle bir markaya inceleme yazılmaz.
...
- **Sıradaki adım (2026-09-25):** Bu plan hâlâ CEO'nun gözünü bekliyor. Dünya çapındaki gelir çalışması onun sözüyle bitti (2026-09-24, dört tur, üç Fable 5.1 oturumu; `../20260924-signal-revenue-study/STUDY.md`, kaynaklar `EVIDENCE.md`, son commit `4ffe9c94`); planın sırası onun "tamam"ıyla onaylı (§3a), planın kendisi değil. "Yap" derse Faz 0 dxb-crew düzeniyle başlar. Onaysız tek satır kod yok.
