...
**THE WORK THE CEO LEFT RUNNING ON 2026-09-03 — carried by board row B43 (the studio); B42 (EXPO measurement row); nothing below opens a new row. Order is his: one topic at a time, one click-question per topic, and the first message of the session states this position before anything else.** <!-- OPEN: B43 -->
