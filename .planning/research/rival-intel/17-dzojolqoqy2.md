...
| **Autonomous publishing** | `AUTO-POSTING` across 109 accounts, 67 videos a day, 2,100 posts this week | **Zero.** No campaign, creator, content, social or trend route exists anywhere in the dashboard | R — `find apps/dashboard/src/app -type d` for those six names → nothing |
