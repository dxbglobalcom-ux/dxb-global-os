...
| **07** | Misael · Founder Systems (`misael.systems`) | `media/07-DbSGx3CCRQS.mp4` | `56d2203b3333185e…` | `frames/07/` — **82 frames** + **4 native zooms** (`zoom/comms-16.0`, `zoom/comms-19.0`, `zoom/math-78.2`, `zoom/math-79.0`) | `transcripts/07.json` — en, 18 segments | *deleted 2026-08-08 on the CEO's live order — the verdict called the rivals' lead "legibility"; row is `fetched`, awaiting a fresh watch under ledger law 7* |
| **08** | `paperclipai/paperclip` — *"the open-source app everyone uses to manage agents at work"* | `repos/paperclip` — 112M, HEAD `7797995` (2026-07-27) | — | — | — | *deleted 2026-08-08 on the CEO's live order — the verdict called the rivals' lead "legibility"; row is `fetched`, awaiting a fresh watch under ledger law 7* |
| **09** | Huw Prosser (`huwprosser`) | `media/09-DYK2IWyoEWh.mp4` | `26a91b04f9e9e4ea…` | `frames/09/` — **15 frames** + 6 scene cuts + **2 native zooms** (`zoom/statusbar-11.0`, `zoom/dock-9.0`) | `transcripts/09.json` — en, 3 segments; **one meaning-changing error corrected from the screen** — the STT hears "Travis", the screen says `JARVIS` | *deleted 2026-08-08 on the CEO's live order — the verdict called the rivals' lead "legibility"; row is `fetched`, awaiting a fresh watch under ledger law 7* |
| **10** | `cloud9.markets` — "Nimbus, multi agent trading desk" | `media/10-DbBAOdVBjka.mp4` | `36bf05ac45b79902…` | `frames/10/` — **75 frames** + **2 native zooms** (`zoom/nimbus-role-12.0`, `zoom/localvoice-62.0`) | `transcripts/10.json` — en, 15 segments | *deleted 2026-08-08 on the CEO's live order — the verdict called the rivals' lead "legibility"; row is `fetched`, awaiting a fresh watch under ledger law 7* |
