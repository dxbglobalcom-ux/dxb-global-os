...
| litellm (proxy) | Locked stack (infra container) | INSTALL | 4 | Cost Monitor / model routing | service | study-cards/litellm.md | Pinned ghcr.io/berriai/litellm:main-stable; installed 2026-07-07 (04-01, CEO checkpoint); 02-05 stub card was absent on disk — FULL card created in 04-01 (deviation recorded); virtual keys + breaker wiring in 04-04 |
| pg-boss | Locked stack (runtime lib) | INSTALL | 3 | State Layer / system-job queue | lib | study-cards/pg-boss.md | PHASE-3-TOOLSET; pinned 12.25.1; installed 2026-07-07 in Phase 4 (04-01, CEO checkpoint 04-01-legitimacy-approval.md) ONLY in packages/outbox-executor — single scheduler process decision |
