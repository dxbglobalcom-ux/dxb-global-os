...
| humanizer | Claude Code ecosystem | STUDY | 10 | Marketing/Sales outbound agents | skill | study-cards/humanizer.md | Mandatory in outbound pipeline before approval gate (DEPT-04); auto in pipeline. [CEO B5 2026-07-09: DXB self-marketing outbound pipeline = explicit Phase-10 criterion 6; mail template = first loop-engine asset candidate (B1 link)] |
...
| OpenMontage, opencut | Media/content | STUDY | 10 | Creative/Social video production | skill | study-cards/openmontage-opencut.md | [B4 audit 2026-07-09: VAR — video zincirinin ÜRETİM yakası; ÖĞRENME yakası ("OS video izleyip öğrenmeli") 07-07 video-learn ile CANLI kapandı (yt-dlp+video-use ADOPT satırı)] |
