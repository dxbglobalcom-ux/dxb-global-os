...
| yt-dlp + video-use | Media/content | INSTALL | 7 | Video-learning module | skill | study-cards/yt-dlp-video-use.md | Auto on video link. INSTALL 2026-07-09 (07-01): pin 2026.07.04, `yt-dlp_linux` sha256-verified → ~/.local/bin, `yt-dlp --version` → 2026.07.04; ADOPT at 07-07 ingest |
| Speaches | Media/content | STUDY | 7 | JARVIS voice backend (VPS) + video-learn STT | service | study-cards/speaches.md | NEW card FILLED 2026-07-09 (07-01): pin `ghcr.io/speaches-ai/speaches:0.8.3-cpu` @ sha256:21e3df0…; INSTALL at 07-05 compose deploy — on-demand `--profile voice` (LOCKED), never in core profile |
...
| hermes-agent | Coding agents | STUDY | 7 | 24/7 VPS resident agent | service | study-cards/hermes-agent.md | 209k stars; locked decision per CLAUDE.md. Card FILLED 2026-07-09 (07-01): pin v0.18.2, LiteLLM base_url contract, systemd shape — Status stays STUDY (no install executed yet); INSTALL lands on VPS 07-06 |
