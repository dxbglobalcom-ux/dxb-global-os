...
| B22 | 2026-07-30 | **The rival analysis must be done again properly** — the sixteen reports were produced from low-quality downloads and sparse frames, and he rejected them on inspection. His directive of 2026-07-29 requires a 720p source floor with 1080p preferred, full temporal analysis instead of frame photography, evidence labels on every statement, and a selective rewrite that keeps what is correct | [[00-CEO-DIRECTIVE-REANALYSIS-AND-DESIGN]] · `.planning/research/rival-intel/` · door `dxb-rival-intel` | The correction directive exists and the work has not begun — he ordered the context architecture first | AUTHOR (on his word) | Every source re-read at genuine quality with labelled evidence, every existing claim kept, corrected or withdrawn with a change log, and the six-wave programme re-derived from what survives |
