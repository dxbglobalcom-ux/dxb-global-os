...
3. The audit report's proposed experts are accepted as input; **Fable adds its own MUST judgment** and decides placement, boundaries, and role levels (this order delegates that decision). **v2 record (2026-07-12 ~15:55):** the CEO explicitly challenged Fable to go beyond the report; Fable's independent discoveries — Stock-Lot & Liquidation Sourcing Specialist (outlet buy-side margin engine) and Managed Automation Services Engineer (consultancy recurring-revenue engine) — were accepted, raising the target to **+19 / 198**. CEO approved the full v2 decision block (plan §10).  <!-- CEO-OK: must-roster-v2-2026-07-12 -->
4. **All new personas: the construction author in person, smartest-expert quality (K2 unchanged — the author is the model that runs the session).** Anything not finished goes on the honest "awaiting authorship" list — quality is never lowered to close a count.
