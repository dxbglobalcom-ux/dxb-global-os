...
| `models` | set_role_slot, set_fallback, set_catalog_status, add_model, test_model | `control_models_*` | banned/mechanical_only denetimi fn içinde ([[MODEL_ROUTING_SPEC]]; Sonnet runtime SERBEST — CEO 2026-07-12); add_model→testing→duman→active akışı §4c |
