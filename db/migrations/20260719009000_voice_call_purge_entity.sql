-- Voice recent-calls list joins the C4 bulk-removal standard (CEO order
-- 2026-07-19 ~13:20): entity 'voice_call' in the audited purge door.
-- Terminal-only (ended/failed); audit_log row per call as with all entities.
